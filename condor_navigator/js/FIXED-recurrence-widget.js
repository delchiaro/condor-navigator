...
recurrence.widget.RuleForm.prototype = {
    ...
    init_dom: function() {
        ...
        var freq_form_container = recurrence.widget.e(
            // 'div', {'class': 'form'});
            'section', {'class': 'section'}); // fix change form to div

        var root = recurrence.widget.e(
            // 'form', {}, [
            'section', {}, [ // Fix (remove firm, use div instead)
...
recurrence.widget.DateForm.prototype = {
    ...
    init_dom: function() {
        ...
        var root = recurrence.widget.e(
            ...
            'div', {'class': 'date'}, [mode_container, date_container]); // fix (use div instead of form)

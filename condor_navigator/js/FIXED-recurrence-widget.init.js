...
/*
    MutationObserver
 */
// FIX for modal form that call this script multiple times and cause "identifier callback has already been declared" error
// FIX: use var instead of const for callback and observer identifiers
